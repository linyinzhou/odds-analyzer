...
- `next_matchday` must include the five major leagues plus Champions League proper; Champions League qualifiers/preliminary/playoffs are excluded.`n- Checker candidates must be concrete predictions, not vague match-direction notes.
